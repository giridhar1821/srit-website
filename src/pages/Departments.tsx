          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h2 className="font-display text-2xl md:text-3xl font-extrabold text-gray-900 dark:text-white">{dept.name}</h2>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Established {dept.established}</p>
                </div>
              </div>

              <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">{dept.description}</p>
              ...
              <div className="p-6 rounded-2xl bg-white dark:bg-neutral-900 border border-gray-100 dark:border-neutral-800 mb-6">
                <h3 className="font-display font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                  <Award size={18} className="text-orange-500" /> Vision
                </h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">{dept.vision}</p>
              </div>

              <div className="grid sm:grid-cols-2 gap-4">
                <div className="p-5 rounded-2xl bg-white dark:bg-neutral-900 border border-gray-100 dark:border-neutral-800">
                  <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-3">Programs Offered</h4>
                ...
                <div className="p-5 rounded-2xl bg-white dark:bg-neutral-900 border border-gray-100 dark:border-neutral-800">
                  <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-3">Specializations</h4>
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="space-y-4">
              <div className="p-6 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 text-white">
                <h3 className="font-display font-bold mb-4">Department at a Glance</h3>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between">
                      <span className="flex items-center gap-2 text-sm text-white/90"><s.icon size={16} /> {s.label}</span>
              ...
              <div className="p-6 rounded-2xl bg-white dark:bg-neutral-900 border border-gray-100 dark:border-neutral-800">
                <h3 className="font-semibold text-gray-900 dark:text-white text-sm mb-2">Head of Department</h3>
                <p className="text-orange-500 font-semibold text-sm">{dept.hod}</p>
              </div>

              <Link to="/admissions" className="btn-orange w-full text-center block inline-flex items-center justify-center gap-2">
                Apply to this program <ArrowRight size={18} />
              </Link>
            </div>
          </div>
        </div>
