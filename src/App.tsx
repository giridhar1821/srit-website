        ...
        <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300">
          ...
          <main>
            <Routes>
              ...
              <Route path="/examination" element={<Placeholder title="Examination" highlight="Cell" subtitle="Hall ticket downloads, results portal, and examination-related information." features={['Hall Ticket Download', 'Results Portal', 'Exam Schedule', 'Internal Marks', 'Revaluation Requests', 'Exam Circulars']} />} />
              <Route path="/student-portal" element={<Placeholder title="Student" highlight="Portal" subtitle="Your personalized dashboard for attendance, results, timetable, fee payment, and more." features={['Attendance Tracking', 'Results & Grades', 'Class Timetable', 'Online Fee Payment', 'Digital Library', 'LMS Access', 'Complaint Portal', 'Hostel Management']} />} />
              <Route path="/faculty-portal" element={<Placeholder title="Faculty" highlight="Portal" subtitle="Tools and resources for faculty members — grading, attendance, research, and more." features={['Grade Entry', 'Attendance Management', 'Research Publications', 'Leave Management', 'Resource Upload', 'Class Schedules']} />} />
